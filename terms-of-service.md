...
When we say “Services”, we mean any product created and maintained by Mipke LLC. That includes Bricks FTW (bricksftw.com) and Everyday Words (everydaywords.io, app.everydaywords.io), whether delivered within a web browser, desktop application, mobile application, or another format.
...
4. When you use our Services, you entrust us with your data. We take that trust to heart. You agree that Mipke LLC may process your data as described in our Privacy Policy and for no other purpose. We as humans can access your data for the following reasons:
...
6. Under the California Consumer Privacy Act (“CCPA”), Mipke LLC is a “service provider”, not a “business” or “third party”, with respect to your use of the Services. That means we process any data you share with us only for the purpose you signed up for and as described in these Terms of Service and Privacy Policy. We do not retain, use, disclose, or sell any of that information for any other commercial purposes unless we have your explicit permission. And on the flip-side, you agree to comply with your requirements under the CCPA and not use Mipke LLC's Services in a way that violates the regulations.
